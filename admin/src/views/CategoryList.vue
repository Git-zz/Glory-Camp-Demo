<template>
    <div>
        <div style="height: 30px; margin-bottom: 30px; color: #545c64; font-size: 20px; font-weight: bold">
            ...
            <span style="margin-left: 8px">分类列表</span>
        </div>
        <el-table :data="items.slice((currentPage - 1)*pageSize, currentPage*pageSize)">
            ...
            <el-table-column fixed="right" label="操作" width="180" align="center">
                <template slot-scope="scope">
                    <el-button type="primary" size="small" @click="$router.push(`/categories/edit/${scope.row._id}`)" icon="el-icon-edit" circle></el-button>
